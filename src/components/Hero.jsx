...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      max-w-7xl mx-auto flex flex-auto items-start gap-5`}
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hello, I'm <span className="text-[#915eff]">Saket</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm an upcoming developer enthusiast
          </p>
        </div>
      </div>
        ...
        <a href="#about">
          ...
          >
            <motion.dev
              ...
              className="w-3 h-3 rounded-full bg-[red] mb-1"
            />
          </div>
        </a>
      </div>
